...
PACKETS_TLM = [
    ...
    "DECOM__TLM__EMULATOR__OBC_524_TM_SET_TEMP_SNS_CFG",
    "DECOM__TLM__EMULATOR__OBC_525_TM_GET_TEMP_SNS_CFG",
    "DECOM__TLM__EMULATOR__OBC_534_TM_SET_PWR_MON_CFG",
    "DECOM__TLM__EMULATOR__OBC_535_TM_GET_PWR_MON_CFG",
    "DECOM__TLM__EMULATOR__OBC_927_TM_GET_DATA_LOGGER_INFO",
    "DECOM__TLM__EMULATOR__OBC_950_TM_GPS_GET_LOCATION_INFO",
    "DECOM__TLM__EMULATOR__OBC_953_TM_GPS_GET_VELOCITY",
    "DECOM__TLM__EMULATOR__OBC_957_TM_SYNC_GPS_TIME",
    "DECOM__TLM__EMULATOR__OBC_951_TM_GPS_GET_3D_POSITION_VELOCITY",
    "DECOM__TLM__EMULATOR__OBC_952_TM_GPS_GET_GPS_TIME_INFO",
    "DECOM__TLM__EMULATOR__OBC_552_TM_OTSU_GET_VERSION",
    "DECOM__TLM__EMULATOR__OBC_626_TM_OTSU_CURRENT_STATUS",
    "DECOM__TLM__EMULATOR__OBC_627_TM_OTSU_SEND_FW_UPDATE_BOOT_CFG",
    "DECOM__TLM__EMULATOR__OBC_630_TM_OTSU_GET_BOOT_CFG_INFO",
    "DECOM__TLM__EMULATOR__OBC_635_TM_OTSU_GET_NVM_FW_VERSION",
    "DECOM__TLM__EMULATOR__OBC_906_TM_GET_FDIR_EEPROM_INFO",
    "DECOM__TLM__EMULATOR__OBC_540_TM_SET_DATA_LOG_CFG",
    "DECOM__TLM__EMULATOR__OBC_541_TM_GET_DATA_LOG_CFG",
    "DECOM__TLM__EMULATOR__OBC_907_TM_FDIR_SET_HW_OPR_STE",
    "DECOM__TLM__EMULATOR__OBC_910_TM_FDIR_SET_WRKG_STS_TMR",
]
# ---------------------------------------------------------
...
PACKETS_CMD = [
    ...
    "DECOM__CMD__EMULATOR__EPS_202_TC_SET_EPS_CONF_OPTION_1",
    ...
    "DECOM__CMD__EMULATOR__OBC_524_TC_SET_TEMP_SNS_CFG",
    "DECOM__CMD__EMULATOR__OBC_525_TC_GET_TEMP_SNS_CFG",
    "DECOM__CMD__EMULATOR__OBC_534_TC_SET_PWR_MON_CFG",
    "DECOM__CMD__EMULATOR__OBC_535_TC_GET_PWR_MON_CFG",
    "DECOM__CMD__EMULATOR__OBC_927_TC_GET_DATA_LOGGER_INFO",
    "DECOM__CMD__EMULATOR__OBC_950_TC_GPS_GET_LOCATION_INFO",
    "DECOM__CMD__EMULATOR__OBC_953_TC_GPS_GET_VELOCITY",
    "DECOM__CMD__EMULATOR__OBC_957_TC_SYNC_GPS_TIME",
    "DECOM__CMD__EMULATOR__OBC_951_TC_GPS_GET_3D_POSITION_VELOCITY",
    "DECOM__CMD__EMULATOR__OBC_952_TC_GPS_GET_GPS_TIME_INFO",
    "DECOM__CMD__EMULATOR__OBC_552_TC_OTSU_GET_VERSION",
    "DECOM__CMD__EMULATOR__OBC_626_TC_OTSU_CURRENT_STATUS_INFO",
    "DECOM__CMD__EMULATOR__OBC_627_TC_OTSU_SEND_FW_UPDATE_BOOT_CFG",
    "DECOM__CMD__EMULATOR__OBC_630_TC_OTSU_GET_BOOT_CFG_INFO",
    "DECOM__CMD__EMULATOR__OBC_635_TC_OTSU_GET_NVM_BINARY_VERSION",
    "DECOM__CMD__EMULATOR__OBC_906_TC_GET_FDIR_EEPROM_INFO",
    "DECOM__CMD__EMULATOR__OBC_540_TC_SET_DATA_LOG_CFG",
    "DECOM__CMD__EMULATOR__OBC_541_TC_GET_DATA_LOG_CFG",
    "DECOM__CMD__EMULATOR__OBC_907_TC_FDIR_SET_HW_OPR_STE",
    "DECOM__CMD__EMULATOR__OBC_910_TC_FDIR_SET_WRKG_STS_TMR",
]
