...
PACKETS_TLM = [
    ...
    "DECOM__TLM__EMULATOR__COMMS_334_TM_COMMS_SBAND_BEACON_START",
    "DECOM__TLM__EMULATOR__COMMS_335_TM_COMMS_SBAND_BEACON_STOP",
    "DECOM__TLM__EMULATOR__COMMS_800_TM_UHF_GET_TM_INFO",
    "DECOM__TLM__EMULATOR__COMMS_803_TM_UHF_GET_TX_CFG",
    "DECOM__TLM__EMULATOR__COMMS_805_TM_UHF_GET_RX_CFG",
    "DECOM__TLM__EMULATOR__COMMS_807_TM_UHF_GET_TX_PKT_CFG",
    "DECOM__TLM__EMULATOR__COMMS_809_TM_UHF_GET_RX_PKT_CFG",
    "DECOM__TLM__EMULATOR__COMMS_811_TM_UHF_GET_RX_PKT_CFG",
    "DECOM__TLM__EMULATOR__COMMS_813_TM_UHF_BEACON_TX_ST",
    "DECOM__TLM__EMULATOR__COMMS_814_TM_UHF_BEACON_TX_STOP",
    "DECOM__TLM__EMULATOR__OBC_256_TM_GET_OBC_NVM_REVISION_NUM",
    "DECOM__TLM__EMULATOR__OBC_1042_TM_EXOTRAIL_GET_PRPLT_TANK_TEMP",
    ...
    "DECOM__TLM__EMULATOR__OBC_605_TM_GET_PS_ES_ACTIVE_INTF",
    "DECOM__TLM__EMULATOR__OBC_604_TC_GET_HINGE_STATUS",
    "DECOM__TLM__EMULATOR__OBC_640_TM_CONFIG_HINGE_RLS_TIMEOUT_TMR",
    "DECOM__TLM__EMULATOR__OBC_650_TC_SET_XBAND_ROUT_PATH",
    "DECOM__TLM__EMULATOR__OBC_503_TC_OBC_MEM_DOWNLOAD",
    "DECOM__TLM__EMULATOR__OBC_925_TM_GET_ON_BRD_TEMP",
    "DECOM__TLM__EMULATOR__OBC_926_TM_GET_ON_BRD_PWR_INFO"
]
# ---------------------------------------------------------
...
PACKETS_CMD = [
    ...
    "DECOM__CMD__EMULATOR__COMMS_334_TC_COMMS_SBAND_BEACON_START",
    "DECOM__CMD__EMULATOR__COMMS_335_TC_COMMS_SBAND_BEACON_STOP",
    "DECOM__CMD__EMULATOR__COMMS_800_TC_UHF_GET_TM_INFO",
    "DECOM__CMD__EMULATOR__COMMS_803_TC_UHF_GET_TX_CFG",
    "DECOM__CMD__EMULATOR__COMMS_805_TC_UHF_GET_RX_CFG",
    "DECOM__CMD__EMULATOR__COMMS_807_TC_UHF_GET_TX_PKT_CFG",
    "DECOM__CMD__EMULATOR__COMMS_809_TC_UHF_GET_RX_PKT_CFG",
    "DECOM__CMD__EMULATOR__COMMS_811_TC_UHF_GET_RX_PKT_CFG",
    "DECOM__CMD__EMULATOR__COMMS_813_TC_UHF_BEACON_TX_ST",
    "DECOM__CMD__EMULATOR__COMMS_814_TC_UHF_BEACON_TX_STOP",
    ...
    "DECOM__CMD__EMULATOR__OBC_605_TC_GET_PS_ES_ACTIVE_INTF",
    "DECOM__CMD__EMULATOR__OBC_604_TC_GET_HINGE_STATUS",
    "DECOM__CMD__EMULATOR__OBC_640_TC_CONFIG_HINGE_RLS_TIMEOUT_TMR",
    "DECOM__CMD__EMULATOR__OBC_650_TC_SET_XBAND_ROUT_PATH",
    "DECOM__CMD__EMULATOR__OBC_503_TC_OBC_MEM_DOWNLOAD",
    "DECOM__CMD__EMULATOR__OBC_925_TC_GET_ON_BRD_TEMP",
    "DECOM__CMD__EMULATOR__OBC_926_TC_GET_ON_BRD_PWR_INFO"
]
