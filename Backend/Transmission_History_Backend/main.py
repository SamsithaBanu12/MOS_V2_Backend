...
PACKETS_TLM = [
    ...
    "DECOM__TLM__EMULATOR__PS_600_TM_PLD_START_SEQUENCE",
    "DECOM__TLM__EMULATOR__PS_604_TM_PLD_HEALTH_STATUS_CMD",
    "DECOM__TLM__EMULATOR__PS_605_TM_PS_HEALTH_STATUS_CMD",
    "DECOM__TLM__EMULATOR__PS_606_TM_PLD_UPDATE_DB_CMD",
    "DECOM__TLM__EMULATOR__PS_607_TM_PLD_GET_DB_CMD",
    "DECOM__TLM__EMULATOR__PS_608_TM_PLD_RESTORE_FACTORY_DATABASE_CMD",
    "DECOM__TLM__EMULATOR__PS_609_TM_PLD_GET_IMAGE_TAG_CMD",
    "DECOM__TLM__EMULATOR__PS_610_TM_PLD_UPGRADE_PLD_CMD",
    "DECOM__TLM__EMULATOR__PS_611_TM_PLD_UPDATE_FACTORY_IMAGE_CMD",
    "DECOM__TLM__EMULATOR__PS_612_TM_PLD_UPDATE_FACTORY_IMAGE_CMD",
    "DECOM__TLM__EMULATOR__PS_613_TM_PC_UPDATE_IMAGE_CMD",
    "DECOM__TLM__EMULATOR__PS_614_TM_PLD_STATSD_CMD",
    "DECOM__TLM__EMULATOR__PS_615_TM_CHANGE_FTM_CONFIG_CMD",
]
# ---------------------------------------------------------
...
PACKETS_CMD = [
    ...
    "DECOM__CMD__EMULATOR__COMMS_465_TC_SBAND_GET_COMMS_TM_INFO",
    "DECOM__CMD__EMULATOR__COMMS_468_TC_SBAND_GET_PROD_KEY",
    "DECOM__CMD__EMULATOR__EPS_200_TC_GET_SUB_SYS_INFO",
    "DECOM__CMD__EMULATOR__EPS_216_TC_SET_EPS_CTRL_DEV_TMR",
    "DECOM__CMD__EMULATOR__EPS_217_TC_GET_EPS_CTRL_DEV_TMR",
    "DECOM__CMD__EMULATOR__EPS_211_TC_SET_DEVICE_STS",
    "DECOM__CMD__EMULATOR__202_TC_SET_EPS_CONF_OPTION_1",
    "DECOM__CMD__EMULATOR__EPS_212_TC_GET_DEVICE_STS",
    "DECOM__CMD__EMULATOR__PS_600_TC_PLD_START_SEQUENCE",
    "DECOM__CMD__EMULATOR__PS_604_TC_PLD_HEALTH_STATUS_CMD",
    "DECOM__CMD__EMULATOR__PS_605_TC_PS_HEALTH_STATUS_CMD",
    "DECOM__CMD__EMULATOR__PS_606_TC_PLD_UPDATE_DB_CMD",
    "DECOM__CMD__EMULATOR__PS_607_TC_PLD_GET_DB_CMD",
    "DECOM__CMD__EMULATOR__PS_608_TC_PLD_RESTORE_FACTORY_DATABASE_CMD",
    "DECOM__CMD__EMULATOR__PS_609_TC_PLD_GET_IMAGE_TAG_CMD",
    "DECOM__CMD__EMULATOR__PS_610_TC_PLD_UPGRADE_PLD_CMD",
    "DECOM__CMD__EMULATOR__PS_611_TC_PLD_UPDATE_FACTORY_IMAGE_CMD",
    "DECOM__CMD__EMULATOR__PS_612_TC_PLD_RESTORE_FACTORY_IMAGE_CMD",
    "DECOM__CMD__EMULATOR__PS_613_TC_PC_UPDATE_IMAGE_CMD",
    "DECOM__CMD__EMULATOR__PS_614_TC_PLD_STATSD_CMD",
    "DECOM__CMD__EMULATOR__PS_615_TC_CHANGE_FTM_CONFIG_CMD",
]
