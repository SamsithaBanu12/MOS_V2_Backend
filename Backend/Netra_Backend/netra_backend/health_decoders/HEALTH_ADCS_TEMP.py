...
SPEC: Dict[str, Any] = {
    ...
    # Table 24: ADCS Temperatures Structure format (11 bytes)
    "segment": [
        {"name": "Operation_Status", "type": "UINT8"},
        {"name": "Epoch_Time_UTC", "type": "UINT32_LE", "transform": "EPOCH32_TO_UTC_DATETIME"},
        {"name": "MCU_Temperature", "type": "INT16_LE"},
        {"name": "Reserved", "type": "INT32_LE"},
    ],
...
# ---------------------------------------------------------------------
def HEALTH_ADCS_TEMP(hex_str: str) -> List[Dict[str, Any]]:
