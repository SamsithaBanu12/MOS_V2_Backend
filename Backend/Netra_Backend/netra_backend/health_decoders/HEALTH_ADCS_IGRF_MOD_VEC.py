...
# ---------------------------------------------------------------------
SPEC: Dict[str, Any] = {
    "name": "HEALTH_ADCS_IGRF_MOD_VEC",
    "expected_queue_id": 14,
    "common_header": {
        "skip_bytes": 26,
        "fields": [
    ...
    # Table 41: HM Modelled Magnetic field vector measurement format (11 bytes)
    "segment": [
        {"name": "Operation_Status", "type": "UINT8"},
        {"name": "Epoch_Time_UTC", "type": "UINT32_LE", "transform": "EPOCH32_TO_UTC_DATETIME"},
        {"name": "IGRF_Mod_Mag_Field_X_uT", "type": "INT16_LE", "scale": 0.01},
        {"name": "IGRF_Mod_Mag_Field_Y_uT", "type": "INT16_LE", "scale": 0.01},
        {"name": "IGRF_Mod_Mag_Field_Z_uT", "type": "INT16_LE", "scale": 0.01},
    ],
...
# ---------------------------------------------------------------------
def HEALTH_ADCS_IGRF_MOD_VEC(hex_str: str) -> List[Dict[str, Any]]:
