...
# ---------------------------------------------------------------------
SPEC: Dict[str, Any] = {
    "name": "HEALTH_ADCS_MAG_FIELD_VEC",
    "expected_queue_id": 13,
    "common_header": {
        "skip_bytes": 26,
        "fields": [
    ...
    # Table 39: HM Magnetic field vector measurement format (11 bytes)
    "segment": [
        {"name": "Operation_Status", "type": "UINT8"},
        {"name": "Epoch_Time_UTC", "type": "UINT32_LE", "transform": "EPOCH32_TO_UTC_DATETIME"},
        {"name": "Mag_Field_Vector_X_uT", "type": "INT16_LE", "scale": 0.01},
        {"name": "Mag_Field_Vector_Y_uT", "type": "INT16_LE", "scale": 0.01},
        {"name": "Mag_Field_Vector_Z_uT", "type": "INT16_LE", "scale": 0.01},
    ],
...
# ---------------------------------------------------------------------
def HEALTH_ADCS_MAG_FIELD_VEC(hex_str: str) -> List[Dict[str, Any]]:
