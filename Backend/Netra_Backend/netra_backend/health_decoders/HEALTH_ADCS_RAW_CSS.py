...
def HEALTH_ADCS_RAW_CSS(hex_str):
    ...
    for idx in range(count):
        ...
        CSS_AD_Value_0= int(seg[10:14], 16) 
        CSS_AD_Value_1= int(seg[14:18], 16) 
        CSS_AD_Value_2= int(seg[18:22], 16) 
        CSS_AD_Value_3= int(seg[22:26], 16) 
        CSS_AD_Value_4= int(seg[26:30], 16) 
        segments.append({
            ...
            'CSS_AD_Value_0':         CSS_AD_Value_0,
            'CSS_AD_Value_1':         CSS_AD_Value_1,
            'CSS_AD_Value_2':         CSS_AD_Value_2,
            'CSS_AD_Value_3':         CSS_AD_Value_3,
            'CSS_AD_Value_4':         CSS_AD_Value_4
        })
    return segments