...
# ---------------------------------------------------------------------
# Queue ID 33: ADCS_HM_SAT_VEL_ECEF_FRAME
# Table 76: HM Satellite velocity in ECEF frame format (29 bytes)
#   - Operation Status (1)
#   - Epoch Time (4)
#   - ECEF Vx (double, 8)
#   - ECEF Vy (double, 8)
#   - ECEF Vz (double, 8)
SPEC: Dict[str, Any] = {
    "name": "HEALTH_ADCS_SAT_VEL_ECEF_FRAME",
    "expected_queue_id": 33,
    "common_header": {
        "skip_bytes": 26,
        "fields": [
    ...
    "segment": [
        ...
        {"name": "ECEF_Vel_X", "type": "FLOAT64_LE"},
        {"name": "ECEF_Vel_Y", "type": "FLOAT64_LE"},
        {"name": "ECEF_Vel_Z", "type": "FLOAT64_LE"},
    ],
...
# ---------------------------------------------------------------------
def HEALTH_ADCS_SAT_VEL_ECEF_FRAME(hex_str: str) -> List[Dict[str, Any]]:
