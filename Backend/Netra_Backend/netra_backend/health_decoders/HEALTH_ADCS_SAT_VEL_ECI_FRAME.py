...
# ---------------------------------------------------------------------
# Queue ID 32: ADCS_HM_SAT_VEL_ECI_FRAME
# Table 74: HM Satellite velocity in ECI frame format (29 bytes)
#   - Operation Status (1)
#   - Epoch Time (4)
#   - ECI Vx (double, 8)
#   - ECI Vy (double, 8)
#   - ECI Vz (double, 8)
SPEC: Dict[str, Any] = {
    "name": "HEALTH_ADCS_SAT_VEL_ECI_FRAME",
    "expected_queue_id": 32,
    "common_header": {
        "skip_bytes": 26,
        "fields": [
    ...
    "segment": [
        ...
        {"name": "ECI_Vel_X", "type": "FLOAT64_LE"},
        {"name": "ECI_Vel_Y", "type": "FLOAT64_LE"},
        {"name": "ECI_Vel_Z", "type": "FLOAT64_LE"},
    ],
...
# ---------------------------------------------------------------------
def HEALTH_ADCS_SAT_VEL_ECI_FRAME(hex_str: str) -> List[Dict[str, Any]]:
