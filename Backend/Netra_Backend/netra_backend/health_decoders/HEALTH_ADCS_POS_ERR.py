...
# ---------------------------------------------------------------------
# Queue ID 27: ADCS_HM_POS_ERR
# Table 66: HM Position error (11 bytes)
#   - Operation Status (1)
#   - Epoch Time (4)
#   - Position X Error : int16 * 0.01
#   - Position Y Error : int16 * 0.01
#   - Position Z Error : int16 * 0.01
SPEC: Dict[str, Any] = {
    "name": "HEALTH_ADCS_POS_ERR",
    "expected_queue_id": 27,
    "common_header": {
        "skip_bytes": 26,
        "fields": [
    ...
    "segment": [
        ...
        {"name": "Position_X_Error", "type": "INT16_LE", "scale": 0.01},
        {"name": "Position_Y_Error", "type": "INT16_LE", "scale": 0.01},
        {"name": "Position_Z_Error", "type": "INT16_LE", "scale": 0.01},
    ],
...
# ---------------------------------------------------------------------
def HEALTH_ADCS_POS_ERR(hex_str: str) -> List[Dict[str, Any]]:
