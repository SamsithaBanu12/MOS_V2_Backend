...
# ---------------------------------------------------------------------
SPEC: Dict[str, Any] = {
    "name": "HEALTH_ADCS_EST_RATES",
    "expected_queue_id": 18,
    "common_header": {
        "skip_bytes": 26,
        "fields": [
    ...
    # Table 49: Estimated Angular Rate Structure format (11 bytes)
    "segment": [
        {"name": "Operation_Status", "type": "UINT8"},
        {"name": "Epoch_Time_UTC", "type": "UINT32_LE", "transform": "EPOCH32_TO_UTC_DATETIME"},
        {"name": "Estimated_Rate_X_deg_s", "type": "INT16_LE", "scale": 0.01},
        {"name": "Estimated_Rate_Y_deg_s", "type": "INT16_LE", "scale": 0.01},
        {"name": "Estimated_Rate_Z_deg_s", "type": "INT16_LE", "scale": 0.01},
    ],
...
# ---------------------------------------------------------------------
def HEALTH_ADCS_EST_RATES(hex_str: str) -> List[Dict[str, Any]]:
