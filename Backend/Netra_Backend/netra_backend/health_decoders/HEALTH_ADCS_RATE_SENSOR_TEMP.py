...
# ---------------------------------------------------------------------
SPEC: Dict[str, Any] = {
    "name": "HEALTH_ADCS_RATE_SENSOR_TEMP",
    "expected_queue_id": 5,
    "common_header": {
        "skip_bytes": 26,
        "fields": [
    ...
    # Table 26: Rate Sensor Temperature Structure format (11 bytes)
    "segment": [
        {"name": "Operation_Status", "type": "UINT8"},
        {"name": "Epoch_Time_UTC", "type": "UINT32_LE", "transform": "EPOCH32_TO_UTC_DATETIME"},
        {"name": "X_Rate_Sensor_Temperature", "type": "INT16_LE"},
        {"name": "Y_Rate_Sensor_Temperature", "type": "INT16_LE"},
        {"name": "Z_Rate_Sensor_Temperature", "type": "INT16_LE"},
    ],
...
# ---------------------------------------------------------------------
def HEALTH_ADCS_RATE_SENSOR_TEMP(hex_str: str) -> List[Dict[str, Any]]:
