...
# ---------------------------------------------------------------------
# Queue ID 26: ADCS_HM_POS_LLH
# Table 64: HM Satellite position in LLH telemetry format (11 bytes)
#   - Operation Status (1)
#   - Epoch Time (4)
#   - Geocentric Longitude : int16 * 0.01  (deg)
#   - Geocentric Latitude  : int16 * 0.01  (deg)
#   - Geocentric Altitude  : int16 * 0.1   (km)
SPEC: Dict[str, Any] = {
    "name": "HEALTH_ADCS_POS_LLH",
    "expected_queue_id": 26,
    "common_header": {
        "skip_bytes": 26,
        "fields": [
    ...
    "segment": [
        ...
        {"name": "Geocentric_Longitude_deg", "type": "INT16_LE", "scale": 0.01},
        {"name": "Geocentric_Latitude_deg", "type": "INT16_LE", "scale": 0.01},
        {"name": "Geocentric_Altitude_km", "type": "INT16_LE", "scale": 0.1},
    ],
...
# ---------------------------------------------------------------------
def HEALTH_ADCS_POS_LLH(hex_str: str) -> List[Dict[str, Any]]:
